...
@Config
@TeleOp(name = "Webcam Red Tower Tuner", group = "Test")
public class Webcam_Tower_Red extends OpMode {
    FtcDashboard dashboard;
    TowerPipeline pipeline = new TowerPipeline(TowerPipeline.Tower.Red);
    Webcam webcam;

    public static int pipline_stage = 0;
    public static HSV_threshold threshold = TowerPipeline.red_hsv.copy();
